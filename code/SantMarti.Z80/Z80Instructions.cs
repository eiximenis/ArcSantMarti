...

{
    ...
    class Z80Instructions
    {
        ...
        private IEnumerable<Instruction> CreateUnprefixedInstructions()
        {
            ...
            unprefixed.Add(new Instruction(0x4, "INC B", 4));
            ...
            unprefixed.Add(new Instruction(0xc, "INC C", 4));
            ...
            unprefixed.Add(new Instruction(0x10, "DJNZ d", 13));
            ...
            unprefixed.Add(new Instruction(0x14, "INC D", 4));
            ...
            unprefixed.Add(new Instruction(0x1c, "INC E", 4));
            ...
            unprefixed.Add(new Instruction(0x2c, "INC L", 4));
            ...
            unprefixed.Add(new Instruction(0x3a, "LD A,(nn)", 13));
            unprefixed.Add(new Instruction(0x3b, "DEC SP", 6));
            unprefixed.Add(new Instruction(0x3c, "INC A", 4));
            ...
            unprefixed.Add(new Instruction(0x72, "LD (HL),D", 7));
            unprefixed.Add(new Instruction(0x73, "LD (HL),E", 7));
            unprefixed.Add(new Instruction(0x74, "LD (HL),H", 7));
            ...
            unprefixed.Add(new Instruction(0xab, "XOR E", 4));
            unprefixed.Add(new Instruction(0xac, "XOR H", 4));
            unprefixed.Add(new Instruction(0xad, "XOR L", 4));
            unprefixed.Add(new Instruction(0xae, "XOR (HL)", 7));
            unprefixed.Add(new Instruction(0xaf, "XOR A", 4));

            unprefixed.Add(new Instruction(0xb0, "OR B", 4));
            unprefixed.Add(new Instruction(0xb1, "OR C", 4));
            unprefixed.Add(new Instruction(0xb2, "OR D", 4));
            unprefixed.Add(new Instruction(0xb3, "OR E", 4));
            unprefixed.Add(new Instruction(0xb4, "OR H", 4));
            unprefixed.Add(new Instruction(0xb5, "OR L", 4));
            unprefixed.Add(new Instruction(0xb6, "OR (HL)", 7));
            unprefixed.Add(new Instruction(0xb7, "OR A", 4));
            ...
            unprefixed.Add(new Instruction(0xc0, "RET NZ", 11));
            unprefixed.Add(new Instruction(0xc1, "POP BC", 10));
            unprefixed.Add(new Instruction(0xc2, "JP NZ,nn", 10));
            ...
            unprefixed.Add(new Instruction(0xca, "JP Z,nn", 10));
            ...
            unprefixed.Add(new Instruction(0xe0, "RET PO", 11));
            ...
            unprefixed.Add(new Instruction(0xf0, "RET P", 11));
            unprefixed.Add(new Instruction(0xf1, "POP AF", 10));
            unprefixed.Add(new Instruction(0xf2, "JP P,nn", 10));
            unprefixed.Add(new Instruction(0xf3, "DI", 4));
            unprefixed.Add(new Instruction(0xf4, "CALL P,nn", 17));
            unprefixed.Add(new Instruction(0xf5, "PUSH AF", 11));
            unprefixed.Add(new Instruction(0xf6, "OR n", 7));
            unprefixed.Add(new Instruction(0xf7, "RST 30", 11));
            unprefixed.Add(new Instruction(0xf8, "RET M", 11));
            unprefixed.Add(new Instruction(0xf9, "LD SP,HL", 6));
            unprefixed.Add(new Instruction(0xfa, "JP M,nn", 10));
            unprefixed.Add(new Instruction(0xfb, "EI", 4));
            unprefixed.Add(new Instruction(0xfc, "CALL M,nn", 17));
