...

{
    ...
    class Z80Instructions
    {
        ...
        private IEnumerable<Instruction> CreateUnprefixedInstructions()
        {
            ...
            unprefixed.Add(new Instruction(0x5, "DEC B", 4, Increment.DEC_B));
            unprefixed.Add(new Instruction(0x6, "LD B,n", 7, Load.LD_R_N));
            ...
            unprefixed.Add(new Instruction(0xd, "DEC C", 4, Increment.DEC_C));
            unprefixed.Add(new Instruction(0xe, "LD C,n", 7, Load.LD_R_N));
            ...
            unprefixed.Add(new Instruction(0x15, "DEC D", 4, Increment.DEC_D));
            unprefixed.Add(new Instruction(0x16, "LD D,n", 7, Load.LD_R_N));
            unprefixed.Add(new Instruction(0x17, "RLA", 4));
            unprefixed.Add(new Instruction(0x18, "JR d", 12, Jump.JR_D));
            ...
            unprefixed.Add(new Instruction(0x1d, "DEC E", 4, Increment.DEC_E));
            unprefixed.Add(new Instruction(0x1e, "LD E,n", 7, Load.LD_R_N));
            ...
            unprefixed.Add(new Instruction(0x25, "DEC H", 4, Increment.DEC_H));
            ...
            unprefixed.Add(new Instruction(0x2d, "DEC L", 4, Increment.DEC_L));
            ...
            unprefixed.Add(new Instruction(0x3d, "DEC A", 4, Increment.DEC_A));
            unprefixed.Add(new Instruction(0x3e, "LD A,n", 7, Load.LD_R_N));
            ...
            unprefixed.Add(new Instruction(0x90, "SUB B", 4, Add.Sub_R));
            unprefixed.Add(new Instruction(0x91, "SUB C", 4, Add.Sub_R));
            unprefixed.Add(new Instruction(0x92, "SUB D", 4, Add.Sub_R));
            unprefixed.Add(new Instruction(0x93, "SUB E", 4, Add.Sub_R));
            unprefixed.Add(new Instruction(0x94, "SUB H", 4, Add.Sub_R));
            unprefixed.Add(new Instruction(0x95, "SUB L", 4, Add.Sub_R));
            unprefixed.Add(new Instruction(0x96, "SUB (HL)", 7, Add.Sub_HLRef));
            unprefixed.Add(new Instruction(0x97, "SUB A", 4, Add.Sub_R));
            ...
            unprefixed.Add(new Instruction(0xe2, "JP PO,nn", 10, Jump.JP_PO_NN));
            ...
            unprefixed.Add(new Instruction(0xfe, "CP n", 7, Logical.CP_N));
        ...
        private IEnumerable<Instruction> CreateCBPrefixedInstructions()
        {
            ...
            cbPrefixed.Add(new Instruction(0x40, "BIT 0,B", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x41, "BIT 0,C", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x42, "BIT 0,D", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x43, "BIT 0,E", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x44, "BIT 0,H", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x45, "BIT 0,L", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x46, "BIT 0,(HL)", 12));
            cbPrefixed.Add(new Instruction(0x47, "BIT 0,A", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x48, "BIT 1,B", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x49, "BIT 1,C", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x4a, "BIT 1,D", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x4b, "BIT 1,E", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x4c, "BIT 1,H", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x4d, "BIT 1,L", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x4e, "BIT 1,(HL)", 12));
            cbPrefixed.Add(new Instruction(0x4f, "BIT 1,A", 8, Bitwise.Bit_R));

            cbPrefixed.Add(new Instruction(0x50, "BIT 2,B", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x51, "BIT 2,C", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x52, "BIT 2,D", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x53, "BIT 2,E", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x54, "BIT 2,H", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x55, "BIT 2,L", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x56, "BIT 2,(HL)", 12));
            cbPrefixed.Add(new Instruction(0x57, "BIT 2,A", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x58, "BIT 3,B", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x59, "BIT 3,C", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x5a, "BIT 3,D", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x5b, "BIT 3,E", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x5c, "BIT 3,H", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x5d, "BIT 3,L", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x5e, "BIT 3,(HL)", 12));
            cbPrefixed.Add(new Instruction(0x5f, "BIT 3,A", 8, Bitwise.Bit_R));

            cbPrefixed.Add(new Instruction(0x60, "BIT 4,B", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x61, "BIT 4,C", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x62, "BIT 4,D", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x63, "BIT 4,E", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x64, "BIT 4,H", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x65, "BIT 4,L", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x66, "BIT 4,(HL)", 12));
            cbPrefixed.Add(new Instruction(0x67, "BIT 4,A", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x68, "BIT 5,B", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x69, "BIT 5,C", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x6a, "BIT 5,D", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x6b, "BIT 5,E", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x6c, "BIT 5,H", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x6d, "BIT 5,L", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x6e, "BIT 5,(HL)", 12));
            cbPrefixed.Add(new Instruction(0x6f, "BIT 5,A", 8, Bitwise.Bit_R));

            cbPrefixed.Add(new Instruction(0x70, "BIT 6,B", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x71, "BIT 6,C", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x72, "BIT 6,D", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x73, "BIT 6,E", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x74, "BIT 6,H", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x75, "BIT 6,L", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x76, "BIT 6,(HL)", 12));
            cbPrefixed.Add(new Instruction(0x77, "BIT 6,A", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x78, "BIT 7,B", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x79, "BIT 7,C", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x7a, "BIT 7,D", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x7b, "BIT 7,E", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x7c, "BIT 7,H", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x7d, "BIT 7,L", 8, Bitwise.Bit_R));
            cbPrefixed.Add(new Instruction(0x7e, "BIT 7,(HL)", 12));
            cbPrefixed.Add(new Instruction(0x7f, "BIT 7,A", 8, Bitwise.Bit_R));
        ...
        private IEnumerable<Instruction> CreateDDCBPrefixedInstructions()
        {
            ...
            ddcbPrefixed.Add(new Instruction(0x40, "BIT 0,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x41, "BIT 0,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x42, "BIT 0,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x43, "BIT 0,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x44, "BIT 0,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x45, "BIT 0,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x46, "BIT 0,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x47, "BIT 0,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x49, "BIT 1,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x4a, "BIT 1,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x4b, "BIT 1,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x4c, "BIT 1,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x4d, "BIT 1,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x4e, "BIT 1,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x48, "BIT 1,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x4f, "BIT 1,(IX+d)", 20, Bitwise.BIT_DispIX));

            ddcbPrefixed.Add(new Instruction(0x50, "BIT 2,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x51, "BIT 2,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x52, "BIT 2,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x53, "BIT 2,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x54, "BIT 2,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x55, "BIT 2,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x56, "BIT 2,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x57, "BIT 2,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x59, "BIT 3,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x5a, "BIT 3,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x5b, "BIT 3,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x5c, "BIT 3,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x5d, "BIT 3,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x5e, "BIT 3,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x58, "BIT 3,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x5f, "BIT 3,(IX+d)", 20, Bitwise.BIT_DispIX));

            ddcbPrefixed.Add(new Instruction(0x60, "BIT 4,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x61, "BIT 4,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x62, "BIT 4,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x63, "BIT 4,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x64, "BIT 4,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x65, "BIT 4,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x66, "BIT 4,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x67, "BIT 4,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x69, "BIT 5,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x6a, "BIT 5,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x6b, "BIT 5,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x6c, "BIT 5,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x6d, "BIT 5,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x6e, "BIT 5,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x68, "BIT 5,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x6f, "BIT 5,(IX+d)", 20, Bitwise.BIT_DispIX));

            ddcbPrefixed.Add(new Instruction(0x70, "BIT 6,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x71, "BIT 6,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x72, "BIT 6,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x73, "BIT 6,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x74, "BIT 6,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x75, "BIT 6,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x76, "BIT 6,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x77, "BIT 6,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x79, "BIT 7,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x7a, "BIT 7,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x7b, "BIT 7,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x7c, "BIT 7,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x7d, "BIT 7,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x7e, "BIT 7,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x78, "BIT 7,(IX+d)", 20, Bitwise.BIT_DispIX));
            ddcbPrefixed.Add(new Instruction(0x7f, "BIT 7,(IX+d)", 20, Bitwise.BIT_DispIX));
        ...
        private IEnumerable<Instruction> CreateFDCBPrefixedInstructions()
        {
            ...
            fdcbPrefixed.Add(new Instruction(0x40, "BIT 0,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x41, "BIT 0,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x42, "BIT 0,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x43, "BIT 0,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x44, "BIT 0,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x45, "BIT 0,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x46, "BIT 0,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x47, "BIT 0,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x49, "BIT 1,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x4a, "BIT 1,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x4b, "BIT 1,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x4c, "BIT 1,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x4d, "BIT 1,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x4e, "BIT 1,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x48, "BIT 1,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x4f, "BIT 1,(IY+d)", 20, Bitwise.BIT_DispIY));

            fdcbPrefixed.Add(new Instruction(0x50, "BIT 2,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x51, "BIT 2,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x52, "BIT 2,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x53, "BIT 2,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x54, "BIT 2,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x55, "BIT 2,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x56, "BIT 2,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x57, "BIT 2,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x59, "BIT 3,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x5a, "BIT 3,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x5b, "BIT 3,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x5c, "BIT 3,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x5d, "BIT 3,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x5e, "BIT 3,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x58, "BIT 3,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x5f, "BIT 3,(IY+d)", 20, Bitwise.BIT_DispIY));

            fdcbPrefixed.Add(new Instruction(0x60, "BIT 4,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x61, "BIT 4,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x62, "BIT 4,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x63, "BIT 4,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x64, "BIT 4,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x65, "BIT 4,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x66, "BIT 4,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x67, "BIT 4,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x69, "BIT 5,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x6a, "BIT 5,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x6b, "BIT 5,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x6c, "BIT 5,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x6d, "BIT 5,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x6e, "BIT 5,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x68, "BIT 5,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x6f, "BIT 5,(IY+d)", 20, Bitwise.BIT_DispIY));

            fdcbPrefixed.Add(new Instruction(0x70, "BIT 6,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x71, "BIT 6,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x72, "BIT 6,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x73, "BIT 6,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x74, "BIT 6,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x75, "BIT 6,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x76, "BIT 6,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x77, "BIT 6,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x79, "BIT 7,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x7a, "BIT 7,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x7b, "BIT 7,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x7c, "BIT 7,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x7d, "BIT 7,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x7e, "BIT 7,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x78, "BIT 7,(IY+d)", 20, Bitwise.BIT_DispIY));
            fdcbPrefixed.Add(new Instruction(0x7f, "BIT 7,(IY+d)", 20, Bitwise.BIT_DispIY));
